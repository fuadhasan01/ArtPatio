...
<!-- Ends Nav code -->
  ...
  <div class="container">
    ...
    <?php
        ...
        $uid= $_SESSION['id'];
        $q= "SELECT * FROM ticketbuy where user_id='$uid'";
          ...
          if($check_images>0){
           ...
           ?>   
              ...
              <div class="overlay">
                ...
                <a href="eventDetailticket.php? eventID=<?php echo $row['eventID']  ?>" style="text-decoration:none;"><button>Event Details</button></a>
                </div>
            </div>
          </div>
    <?php

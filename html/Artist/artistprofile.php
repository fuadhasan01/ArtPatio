    ...
    <div class="wholePart">
        <div class="left">
            ...
            <div class="userImage">
                ...
                <p> Total Followers: <?php echo $_SESSION['followers'];?></p>
            </div>
        ...
        <div class="right">
            ...
            <div class="profileInfo">
                ...
                <div class="infoRight">
                    <input type="text" name="" id="" placeholder="<?php echo $_SESSION['name'];?>" value="<?php echo $_SESSION['name'];?>" disabled>
                    <input type="email" name="" placeholder="<?php echo $_SESSION['email'];?>" id=""value="<?php echo $_SESSION['email'];?> "disabled>
                    <input type="text" name="" placeholder="<?php echo $_SESSION['contact'];?>" id=""value="+88<?php echo $_SESSION['contact'];?>"disabled>
                    <input type="text" name="" placeholder="<?php echo $_SESSION['address'];?>" id=""value="<?php echo $_SESSION['address'];?>"disabled>
                    
                    <a href="artistprofileEdit.php"><button>Edit Pofile</button></a>
                </div>
            </div>

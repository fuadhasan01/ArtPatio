...
<main>
  ...
  <div class="search-area">
      <span class="search-icon" style="padding-top: 5px;"><i class="fas fa-search" style="color: #b1b1b1;"></i></span>
      <input type="search" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];}?>"class="form-control"  placeholder="Search Arts">
  </div>
  <h1 style="text-align: center; margin:0 0 0px;">
    Arts
  </h1>
  </form>
</main>
  ...
  <div class="container">
    ...
    <?php
     ...
     if(isset($_GET['search'])){
      ...
      $query="SELECT * FROM arts where title LIKE '%$filevalue%' or description LIKE '%$filevalue%' or type LIKE '%$filevalue%'";
      ...
      if($check_images>0){
         ...
         $query="SELECT * FROM arts where approval = 1 ORDER BY votes DESC LIMIT 3";
  ...
  <div style="width:fit-content; margin:auto; ">
      <button onclick="window.location.href='art.php'">View More Arts</button>
    </div>
  ...
  <div class="search-area">
      <span class="search-icon" style="padding-top: 5px;"><i class="fas fa-search" style="color: #b1b1b1;"></i></span>
      <input type="search" name="search1" value="<?php if(isset($_GET['search1'])){echo $_GET['search1'];}?>"class="form-control"  placeholder="Search Events">
  </div>
  <h1 style="text-align: center; margin:0 0 0px;">
    Events  
  </h1>
  ...
  <div class="container">
    <?php
     if(isset($_GET['search1'])){
      ...
      $filevalue=$_GET['search1'];
      $query="SELECT * FROM event where  approval=1 and (eventname LIKE '%$filevalue%')";
      $result = mysqli_query($conn, $query);
      $check_images= mysqli_num_rows($result);
      ...
      if($check_images>0){
        ...
        $query="SELECT * FROM event where approval=1  LIMIT 3";
         $result = mysqli_query($conn, $query);
         $check_images= mysqli_num_rows($result);
          if($check_images>0){
            while($row=mysqli_fetch_array($result)){
  ...
  <div style="width:fit-content; margin:auto; ">
      <button onclick="window.location.href='event.php'">View More Events</button>
    </div>

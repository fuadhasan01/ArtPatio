...
<main>
  ...
  <div class="search-area">
      <input type="search" name="search" class="form-control"  placeholder="Search Artist" id="searchBar">
  ...
  <div class="container">
    <?php
        ...
        $query= "SELECT * FROM user_profile WHERE category='Artist'and id!='".$_SESSION['id']."'";
        ...
        if($check_images>0){
            while($row=mysqli_fetch_array($result)){
              ...
              <div class="overlay">
                <h1>Name: <?php echo  $artist  ?></h1>
                <div style="width: fit-content; margin: auto">
                <a href="ArtistDetail.php? id=<?php echo $id?>" style="text-decoration:none;"><button>Artist Details</button></a>
                </div>
            </div>
          </div>
        <?php  

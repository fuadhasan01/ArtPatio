        ...
        <div class="right">
            ...
            <div class="header" style="position: relative;">
                ...
                <a href="artistprofile.php">Profile</a>
                    ...
                    <a href="purchasedarts.php">Purchased Itemps</a>
            ...
            <div class="profileInfo">
                ...
                <div class="infoRight">
                    ...
                    <input type="text" name="" placeholder="<?php echo $_SESSION['contact'];?>" id=""value="<?php echo $_SESSION['contact'];?>"disabled>
                    <input type="text" name="" placeholder="<?php echo $_SESSION['address'];?>" id=""value="<?php echo $_SESSION['address'];?>"disabled>
                    
                    <a href="profileEdit.php"><button >Edit Pofile</button></a>
                </div>
            </div>
